function [BW,maskedRGBImage] = cam2_1Mask(RGB)
%cam2_1Mask  Threshold RGB image using auto-generated code from colorThresholder app.
%  [BW,MASKEDRGBIMAGE] = cam2_1Mask(RGB) thresholds image RGB using
...
shiftVec = [125.876377 129.753691 102.404544];
I = I - shiftVec;
I = [I ones(size(I,1),1)]';

% Apply transformation matrix
tMat = [-0.007837 -0.002636 0.000000 0.606815;
    0.000394 -0.002095 0.003723 -0.417383;
    0.001930 -0.010274 -0.000759 9.101731;
...
hPoints(1).data = [0.749955 0.064252;
    0.757296 -0.041562;
    1.082725 -0.143727;
    1.119428 -0.001425];
